...
if [ -z "${ETHEREUM_READER_SERVER_BASE_DIR+xxx}" ]; then echo "ETHEREUM_READER_SERVER_BASE_DIR is not set, setting ETHEREUM_READER_SERVER_BASE_DIR=$ROOT_LOCAL_APP_DIR/ethereum_reader_server"; ETHEREUM_READER_SERVER_BASE_DIR=$ROOT_LOCAL_APP_DIR/ethereum_reader_server; else echo "ETHEREUM_READER_SERVER_BASE_DIR was set to $ETHEREUM_READER_SERVER_BASE_DIR"; fi
if [ -z "${ETHEREUM_READER_SERVER_EXEC_DIR+xxx}" ]; then echo "ETHEREUM_READER_SERVER_EXEC_DIR is not set, setting ETHEREUM_READER_SERVER_EXEC_DIR=$ROOT_LOCAL_APP_DIR/ethereum_reader_server"; ETHEREUM_READER_SERVER_EXEC_DIR=$ROOT_LOCAL_APP_DIR/ethereum_reader_server; else echo "ETHEREUM_READER_SERVER_EXEC_DIR was set to $ETHEREUM_READER_SERVER_EXEC_DIR"; fi
...
export ETHEREUM_READER_SERVER_BASE_DIR;
export ETHEREUM_READER_SERVER_EXEC_DIR;
	

export PATH=$NPM_DIR:$PATH
echo "PATH is $PATH"

cd $ETHEREUM_READER_SERVER_BASE_DIR
